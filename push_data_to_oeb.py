...
from oeb_level2.process.participant import (
    Participant,
    ParticipantConfig,
)
...
#        "format": LOGFORMAT,
    ...
    level2_min_validator, num_level2_schemas = oeb_level2.schemas.create_validator_for_oeb_level2()
    ...
    try:
        ...
        config_val_list = level2_min_validator.jsonValidate(config_json_filename, guess_unmatched=[oeb_level2.schemas.SUBMISSION_FORM_SCHEMA_ID])
        ...
        oeb_credentials_val_list = level2_min_validator.jsonValidate(oeb_credentials_filename, guess_unmatched=[oeb_level2.schemas.AUTH_CONFIG_SCHEMA_ID])
    ...
    validated_data = level2_min_validator.jsonValidate(validable_data, guess_unmatched=[oeb_level2.schemas.MINIMAL_DATA_BLOCK_SCHEMA_ID])
    ...
    a_d_collisions = migration_utils.check_dataset_collisions(
        ...
        default_schema_url=[
            oeb_level2.schemas.SINGLE_METRIC_SCHEMA_ID
        ]
    )
    ...
    agg_d_collisions = migration_utils.check_dataset_collisions(
        ...
        default_schema_url=[
            oeb_level2.schemas.AGGREGATION_2D_PLOT_SCHEMA_ID,
            oeb_level2.schemas.AGGREGATION_BAR_PLOT_SCHEMA_ID,
        ]
    )
...
if __name__ == '__main__':
    ...
    main(config_json_filename, args.oeb_submit_api_creds, args.oeb_submit_api_token, args.val_output, args.dry_run, args.dry_run is not None, args.logFilename)
